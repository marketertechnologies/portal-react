            ...
            <div className="bg-white w-[480px] max-w-[480px]">
                <div className="flex flex-col gap-8 p-8 relative">
                    ...
                    <div className="flex gap-4">
                        <button className="flex-1 border hover:border-black text-black py-2 px-4 rounded-full inline-flex justify-center gap-2">Send på e-post <IconArrowRight /></button>
                        <button className="flex-1 border hover:border-black text-black py-2 px-4 rounded-full inline-flex justify-center gap-2">Send på SMS <IconArrowRight /></button>
                    </div>
                </div>
            </div>
        </Modal>
